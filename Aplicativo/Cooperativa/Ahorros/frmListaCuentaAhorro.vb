...
Public Class frmListaCuentaAhorro
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmListaCuentaAhorro))
...
#End Region
    ...
    Private Sub frmListaCuentaAhorro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        FillListView()
    End Sub
    Private Sub frmListaCuentaAhorro_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Public Sub FillListView()
        ...
        If Trim(txtBuscar.Text) <> "" Then
            sqlSearch = "SELECT a.ID, c.fld_FullName AS Cliente, a.CuentaNo, a.FechaApertura FROM tbl_ahorros_cuentas AS a INNER JOIN tbl_clientes AS c ON a.IDCliente=c.fld_id WHERE Estado='Activa' AND " & fldToSearch & " LIKE " & strTosearch & " ORDER BY a.FechaApertura ASC"
        Else
            sqlSearch = "SELECT a.ID, c.fld_FullName AS Cliente, a.CuentaNo, a.FechaApertura FROM tbl_ahorros_cuentas AS a INNER JOIN tbl_clientes AS c ON a.IDCliente=c.fld_id WHERE Estado='Activa' ORDER BY a.FechaApertura ASC"
        End If
    ...
    Private Sub frmListaCuentaAhorro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
