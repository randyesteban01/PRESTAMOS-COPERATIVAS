...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmRetirosLista))
        ...
        Me.Name = "frmRetirosLista"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista de Retiros"
...
#End Region
    ...
    Private Sub frmRetirosLista_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        FillListView()
    End Sub
    Public Sub FillListView()
        ...
        If Trim(txtBuscar.Text) <> "" Then
            sqlSearch = "SELECT d.ID, d.Fecha, ac.CuentaNo, c.fld_FullName, d.Monto FROM tbl_ahorros_retiros AS d, tbl_clientes AS c, tbl_ahorros_cuentas AS ac WHERE d.IDCliente = c.fld_id AND ac.ID = d.IDAhorro  AND " & fldToSearch & " LIKE " & strTosearch & "  ORDER BY d.Fecha DESC LIMIT 0, 15; "
        Else
            sqlSearch = "SELECT d.ID, d.Fecha, ac.CuentaNo, c.fld_FullName, d.Monto FROM tbl_ahorros_retiros AS d, tbl_clientes AS c, tbl_ahorros_cuentas AS ac WHERE d.IDCliente = c.fld_id AND ac.ID = d.IDAhorro ORDER BY d.Fecha DESC LIMIT 0, 15; "
        End If
    ...
    Private Sub frmRetirosLista_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.Chr(27) Then
            Me.Close()
        End If
    End Sub

    Private Sub frmRetirosLista_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
