...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAporteSocio))
        ...
        Me.imprimirBtn.Location = New System.Drawing.Point(245, 216)
        ...
        Me.Label4.Text = "REGISTRO APORTE DE SOCIOS"
        ...
        Me.guardarBtn.Location = New System.Drawing.Point(173, 216)
        ...
        Me.Name = "frmAporteSocio"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Aporte de Socio"
...
#End Region
    ...
    Private Sub frmAporteSocio_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        LlenarCajas()
    ...
    Private Function guardarDatos() As Integer
        NON_QUERY("INSERT INTO tbl_ahorros_aportacion (IDSocio, Fecha, Monto, Concepto, IdCaja) VALUES	(" & CInt(IdSocioTxt.Text) & ", Now(), " & CDbl(montoTxt.Text) & ", '" & conceptoTxt.Text & "'," & cmbCajas.SelectedValue & ");")

        Return SCALAR_NUM("SELECT MAX(ID) FROM tbl_ahorros_aportacion")
    End Function
    Private Sub guardarBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles guardarBtn.Click
        ...
        Dim fecha As Date = CDate(SCALAR_STRING("SELECT Now()"))
        Dim idTran = CargarFrmInterfas(ctaContableCaja, nombreCta, montoTxt.Text, 0, 0, "Aportacion de Socio", conceptoTxt.Text, fecha.Date, idTipoTrans)
        ...
        If idTran > 0 Then
            ...
            If CBool(SCALAR_NUM("SELECT VistaPreviaImpresion FROM parametrosgenerales WHERE ID=1")) = True Then
                Id = Id
                AllReportSinFecha("Recibo Aporte")
                Me.Close()
            Else
    ...
    Private Sub imprimirBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles imprimirBtn.Click
        Dim f As New frmAporteSocioLista
        f.ShowDialog()
    ...
    Private Sub frmAporteSocio_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
