...
Public Class frmSolicitudCreditoCliente
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmSolicitudCreditoCliente))
        ...
        Me.Name = "frmSolicitudCreditoCliente"
...
#End Region
    ...
    Private Sub frmSolicitudCreditoCliente_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        LlenarZona()
        LlenarCiudad()
        LlenarTipoDocumento()
    ...
    Private Sub frmSolicitudCreditoCliente_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Private Sub SaveData()
        Try
            ...
            cmd.Dispose()
            fld_Codigo.Text = Format(UltimoID("SolicitudCreditoCliente", "fld_id"), "0000")
    ...
    Private Sub LoadData(ByVal idCliente As Integer)
        ...
        With cmd
            .CommandText = "SELECT * FROM SolicitudCreditoCliente WHERE fld_id=" & idCliente & ""
            .Connection = conn
            .Connection.Open()
            dr = .ExecuteReader
        End With
        ...
        If dr.Read Then
            ...
            fldedad.Text = edadExacta(dtpEdad.Value.Date)
            fldtiempoempresa.Text = edadExacta(dtpFechaIngresos.Value.Date)
        Else
            btnGuardar.Text = "&Guardar"
    ...
    Private Sub NullData(ByVal Id As Integer)
        ...
        Dim da As New MySqlDataAdapter("SELECT * FROM SolicitudCreditoCliente WHERE fld_id=" & Id & "", conn)
        ...
        da.Update(ds, "SolicitudCreditoCliente")
        ds.AcceptChanges()
        conn.Close()
    ...
    Private Sub CLIENTES_TODOS()
        ...
        Dim sqlstring = "SELECT * FROM SolicitudCreditoCliente"
    ...
    Private Sub update_clientes(ByVal id_cliente As String, ByVal apellido1 As String)
        ...
        With cmd
            .Connection = conn
            .Connection.Open()
            .CommandText = "UPDATE SolicitudCreditoCliente SET fld_LastName1='" & apellido1 & "' WHERE fld_id=" & id_cliente & ""
            .ExecuteNonQuery()
            .Connection.Close()
        End With
        cmd.Dispose()
    ...
    Private Sub MARCA_STATUS()
        Dim ds As New DataSet
        Dim dr As DataRow
        Dim da As New MySqlDataAdapter("SELECT * FROM SolicitudCreditoCliente", conn)
        da.Fill(ds, "SolicitudCreditoCliente")
        For Each dr In ds.Tables(0).Rows
            dr("fld_Status") = "N"
            dr("fld_Phone") = "N/A"
    ...
    Private Sub btnLimite_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLimite.Click
        If FRMS_CLAVE_MAESTRA("Acceso") = True Then
            NON_QUERY("UPDATE SolicitudCreditoCliente SET fld_limite=" & CDbl(txtLimite.Text) & " WHERE fld_id=" & fld_Codigo.Text & "")
        End If
    End Sub
    ...
    Private Sub frmSolicitudCreditoCliente_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
