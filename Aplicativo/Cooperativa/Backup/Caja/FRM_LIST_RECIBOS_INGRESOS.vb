...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRM_LIST_RECIBOS_INGRESOS))
        ...
        Me.LV.Name = "LV"
        Me.LV.Size = New System.Drawing.Size(768, 296)
        Me.LV.TabIndex = 1
        '
        'txtdescription
        '
        ...
        'dtpFecha
        '
        Me.dtpFecha.Location = New System.Drawing.Point(792, 56)
    ...
    Private Sub LV_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles LV.KeyDown
        ...
        ElseIf e.KeyCode = Keys.Delete Then
                If FRMS_CLAVE_MAESTRA("Borrar") = True Then
                    ...
                    READER("SELECT fld_id_cliente_ri, fld_monto, fld_concepto FROM tbl_recibo_ingresos_cxc WHERE fld_Id_RI=" & LV.FocusedItem.Text & "")

                    Dim IdTipo As Integer, Monto As Double = 0, Concepto As String = ""
                    If reader_values.Length > 0 Then
                        IdTipo = reader_values(0)
                        Monto = reader_values(1)
                        Concepto = reader_values(2)
                    End If
                    ActualizaCuotas(CInt(LV.FocusedItem.Text))

                    'formatDate(fld_fecha.Value.Date)

                    create_row_estado_cliente(CStr(IdTipo), Monto, "INGRESO NULOS", LV.FocusedItem.Text, "(NULO) " & Concepto, formatDate(dtpFecha.Value.Date))

                    NON_QUERY("UPDATE tbl_recibo_ingresos_cxc SET fld_concepto=CONCAT('(NULO) ',fld_concepto),fld_interes_cobrado=0, fld_capital_cobrado=0, fld_mora_cobrada=0, fld_monto=0 WHERE fld_Id_RI=" & LV.FocusedItem.Text & "")
                    FillLV()
                End If
