...
Public Class FRM_ESTADO_PROVEEDOR
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRM_ESTADO_PROVEEDOR))
        ...
        Me.lblCedula.TabIndex = 56
        Me.lblCedula.Text = "RNC"
        ...
        'LV
        '
        Me.LV.Location = New System.Drawing.Point(8, 171)
        Me.LV.Name = "LV"
        Me.LV.Size = New System.Drawing.Size(792, 282)
        Me.LV.TabIndex = 59
        '
        'txtConcepto
        '
        ...
        Me.Label8.Location = New System.Drawing.Point(344, 40)
        ...
        Me.Label7.Location = New System.Drawing.Point(344, 16)
        ...
        Me.dtpDesde.TabIndex = 75
        '
        'Label9
        '
        Me.Label9.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!)
        Me.Label9.Location = New System.Drawing.Point(440, 149)
        ...
        Me.txtBceAnterior.Location = New System.Drawing.Point(616, 147)
        ...
        Me.Name = "FRM_ESTADO_PROVEEDOR"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Estado de Cuenta de Proveedor"
...
#End Region
    ...
    Private Sub FRM_ESTADO_PROVEEDOR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        dtpDesde.Value = PrimerDiaDelMes(dtpDesde.Value.Date)
        dtpHasta.Value = UltimoDiaDelMes(dtpHasta.Value.Date)
    End Sub
    Private Function BceAnterior(ByVal IdProveedor As String) As Double

        BceAnterior = SCALAR_NUM("SELECT IFNULL(SUM(fld_cr)-SUM(fld_dr),0) FROM tbl_estado_proveedor WHERE fld_proveedor_id='" & IdProveedor & "' AND fld_date < '" & formatDate(dtpDesde.Value.Date) & "' GROUP BY fld_proveedor_id")

    End Function
    Private Sub BuscarProveedor(ByVal id As Integer)


        Dim cmd As New MySqlCommand, dr As MySqlDataReader

        With cmd
            .CommandText = "SELECT * FROM tbl_Supplier WHERE fldSupplierID=" & id & ""
            .Connection = conn
            .Connection.Open()
            dr = .ExecuteReader
        End With
        ...
        If dr.Read Then
            fld_Codigo.Text = id
            fld_FullName.Text = dr("fldCompany")
            fld_Identity.Text = dr("fldCel")
        End If
    ...
    Private Sub LlenarListView(ByVal IdProveedor As String)
        LV.Clear()
        ...
        Try
            ...
            sqlSearch = "SELECT fld_id_ec_p, fld_tipo_doc, fld_date, fld_description, fld_dr, fld_cr, fld_bce_proveedor FROM tbl_estado_proveedor WHERE fld_proveedor_id='" & IdProveedor & "' AND fld_date >='" & formatDate(dtpDesde.Value.Date) & "'  AND fld_date <= '" & formatDate(dtpHasta.Value.Date) & "' ORDER BY fld_id_ec_p"
            ...
            da.Fill(ds, "tbl_estado_proveedor")

            Dim debito As Double = 0, credito As Double = 0

            Dim Bce As Decimal = BceAnterior(IdProveedor)
    ...
    Private Sub LV_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LV.Click
        txtConcepto.Text = SCALAR_STRING("SELECT fld_description FROM tbl_estado_proveedor WHERE fld_id_ec_p=" & LV.FocusedItem.Text & "")
    End Sub
    ...
    Private Sub btnImprime_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprime.Click
        ...
        AllReportSinFecha("ESTADO_CUENTA_PROVEEDOR")
    End Sub
