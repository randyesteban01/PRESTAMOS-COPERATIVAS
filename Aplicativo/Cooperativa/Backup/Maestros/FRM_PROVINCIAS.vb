...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRM_PROVINCIAS))
        ...
        Me.fldCodigo.Location = New System.Drawing.Point(160, 384)
        ...
        Me.Button2.Location = New System.Drawing.Point(8, 352)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(240, 352)
        ...
        Me.BtnProcesar.Location = New System.Drawing.Point(80, 352)
...
#End Region
    ...
    Private Sub FRM_PROVINCIAS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        FILL_LIST_VIEW()
    End Sub
    ...
    Private Sub SAVE_DATA()
        ...
        NON_QUERY("INSERT INTO tbl_provincia (fldDescripcion) VALUES('" & fldDescripcion.Text & "')")
    ...
    Private Sub UPDATE_DATA()
        ...
        NON_QUERY("UPDATE tbl_provincia SET fldDescripcion='" & fldDescripcion.Text & "' WHERE fldCodigo = " & fldCodigo.Text & "")
        CLEAR_DATA()
    ...
    Private Sub LOAD_DATA(ByVal id_doc As Integer)
        ...
        With cmd
            .CommandText = "SELECT * FROM tbl_provincia WHERE fldCodigo =" & id_doc & ""
            .Connection = conn
            .Connection.Open()
            dr = .ExecuteReader
    ...
    Private Sub DELETE_DATA(ByVal id_doc As String)
        ...
        If Alerta("¿Seguro que desea continuar?") <> "YES" Then
            Exit Sub
        End If

        NON_QUERY("DELETE FROM tbl_provincia WHERE fldCodigo=" & id_doc & "")
        FILL_LIST_VIEW()
    End Sub
    ...
    Private Sub FILL_LIST_VIEW()
        ...
        If strTosearch <> "" Then
            sqlSearch = "SELECT fldCodigo, fldDescripcion FROM tbl_provincia WHERE " & fldToSearch & " LIKE " & strTosearch & " ORDER BY fldDescripcion ASC LIMIT 150"
        Else
            sqlSearch = "SELECT fldCodigo, fldDescripcion FROM tbl_provincia ORDER BY fldDescripcion ASC LIMIT 150"
        End If

        Dim da As New MySqlDataAdapter(sqlSearch, conn)
        da.Fill(ds, "tbl_provincia")
