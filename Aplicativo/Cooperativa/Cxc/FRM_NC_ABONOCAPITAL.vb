...
Imports System.IO
Public Class FRM_NC_ABONOCAPITAL
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRM_NC_ABONOCAPITAL))
        ...
        Me.btn_cobrar.Location = New System.Drawing.Point(96, 160)
        ...
        Me.btnCierra.Location = New System.Drawing.Point(296, 160)
        ...
        'Label11
        '
        Me.Label11.BackColor = System.Drawing.Color.FromArgb(CType(128, Byte), CType(255, Byte), CType(128, Byte))
        ...
        Me.Label11.Text = "NOTA DE CREDITO - ABONO A CAPITAL"
        ...
        'dtpFecha
        '
        Me.dtpFecha.Location = New System.Drawing.Point(176, 184)
...
#End Region
    ...
    Private Sub GeneraCuotas(ByVal IdPrestamo As Integer, ByVal Interes As Double, ByVal Capital As Double)
        ...
        If tipoPrestamos = "INT. ADELANTADO MENSUAL" Then
    ...
    Private Sub COBRANDO()
        ...
        If (result = Windows.Forms.DialogResult.OK) Then
            ...
            PRINT_DOCUMENTO_NCCXC(UltimoID("tbl_nc_cxc", "fld_id_nc_cxc"), PrintDialog1.PrinterSettings.PrinterName)
    ...
    Private Sub LISTA_CLIENTES()
        If FRMS_POPUP_CLIENTES("TODOS") = True Then
            ...
            If FRMS_LIST_PRESTAMOS_POR_CLIENTE(txtFirstName.Text, Id) = True Then
                'If SCALAR_STRING("SELECT fld_tipo_prestamo FROM tbl_prestamos WHERE fld_id_prestamos=" & Id & "") <> "INTERES ADELANTADO" Then
                ...
                tipoPrestamos = SCALAR_STRING("SELECT fld_tipo_prestamo FROM tbl_prestamos WHERE fld_id_prestamos=" & Id & "")

                If tipoPrestamos = "Int. y Adelantado" Then
                    fld_id_prestamo.Text = Id
                    CargarVariable(CInt(fld_id_prestamo.Text))
                    txtFormaDePago.Focus()
                Else
    ...
    Private Sub FRM_NC_ABONOCAPITAL_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
