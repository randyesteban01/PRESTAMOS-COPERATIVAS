...
Public Class RPT_CUENTA_AHORRO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CUENTA_AHORRO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CUENTA_AHORRO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CUENTA_AHORRO = New RPT_CUENTA_AHORRO()
        rpt.Site = Me.Site
        Return rpt
    End Function
