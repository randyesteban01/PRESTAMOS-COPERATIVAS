...
Public Class rptSaldoDeCapital
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptSaldoDeCapital.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldoDeCapital
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldoDeCapital = New rptSaldoDeCapital()
        rpt.Site = Me.Site
        Return rpt
    End Function
