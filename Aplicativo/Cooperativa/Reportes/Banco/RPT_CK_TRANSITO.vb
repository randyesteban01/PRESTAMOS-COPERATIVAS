...
Public Class RPT_CK_TRANSITO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CK_TRANSITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CK_TRANSITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CK_TRANSITO = New RPT_CK_TRANSITO()
        rpt.Site = Me.Site
        Return rpt
    End Function
