...
Public Class RPT_CONCILIACION
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CONCILIACION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CONCILIACION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CONCILIACION = New RPT_CONCILIACION()
        rpt.Site = Me.Site
        Return rpt
    End Function
