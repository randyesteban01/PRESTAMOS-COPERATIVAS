...
Public Class RPT_DEPOSITOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_DEPOSITOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_DEPOSITOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_DEPOSITOS = New RPT_DEPOSITOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
