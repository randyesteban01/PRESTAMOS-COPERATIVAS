...
Public Class RPT_DEP_TRANSITO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_DEP_TRANSITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_DEP_TRANSITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_DEP_TRANSITO = New RPT_DEP_TRANSITO()
        rpt.Site = Me.Site
        Return rpt
    End Function
