...
Public Class RPT_NC_TRANSITO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_NC_TRANSITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_NC_TRANSITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_NC_TRANSITO = New RPT_NC_TRANSITO()
        rpt.Site = Me.Site
        Return rpt
    End Function
