...
Public Class RPT_ND_TRASITO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_ND_TRASITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ND_TRASITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ND_TRASITO = New RPT_ND_TRASITO()
        rpt.Site = Me.Site
        Return rpt
    End Function
