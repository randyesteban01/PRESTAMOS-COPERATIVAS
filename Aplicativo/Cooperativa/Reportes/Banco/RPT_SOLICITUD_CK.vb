...
Public Class RPT_SOLICITUD_CK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_SOLICITUD_CK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_SOLICITUD_CK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_SOLICITUD_CK = New RPT_SOLICITUD_CK()
        rpt.Site = Me.Site
        Return rpt
    End Function
