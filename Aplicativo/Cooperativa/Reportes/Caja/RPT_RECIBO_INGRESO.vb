...
Public Class RPT_RECIBO_INGRESO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_RECIBO_INGRESO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_RECIBO_INGRESO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_RECIBO_INGRESO = New RPT_RECIBO_INGRESO()
        rpt.Site = Me.Site
        Return rpt
    End Function
