...
Public Class RTP_CUADRE_CAJA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RTP_CUADRE_CAJA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRTP_CUADRE_CAJA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RTP_CUADRE_CAJA = New RTP_CUADRE_CAJA()
        rpt.Site = Me.Site
        Return rpt
    End Function
