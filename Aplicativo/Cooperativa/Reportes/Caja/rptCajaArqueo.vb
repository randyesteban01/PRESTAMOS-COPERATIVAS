...
Public Class rptCajaArqueo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptCajaArqueo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCajaArqueo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCajaArqueo = New rptCajaArqueo()
        rpt.Site = Me.Site
        Return rpt
    End Function
