...
Public Class rptLibroMayol
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptLibroMayol.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroMayol
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroMayol = New rptLibroMayol()
        rpt.Site = Me.Site
        Return rpt
    End Function
