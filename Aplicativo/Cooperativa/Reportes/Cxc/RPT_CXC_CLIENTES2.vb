...
Public Class RPT_CXC_CLIENTES2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CXC_CLIENTES2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter__fecha1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter__fecha2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_CXC_CLIENTES2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CXC_CLIENTES2 = New RPT_CXC_CLIENTES2()
        rpt.Site = Me.Site
        Return rpt
    End Function
