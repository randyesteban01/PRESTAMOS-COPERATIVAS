...
Public Class RPT_ESTADO_CLIENTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_ESTADO_CLIENTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ESTADO_CLIENTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ESTADO_CLIENTE = New RPT_ESTADO_CLIENTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
