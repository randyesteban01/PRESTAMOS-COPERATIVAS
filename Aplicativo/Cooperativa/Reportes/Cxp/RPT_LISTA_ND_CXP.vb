...
Public Class RPT_LISTA_ND_CXP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_LISTA_ND_CXP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_LISTA_ND_CXP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_LISTA_ND_CXP = New RPT_LISTA_ND_CXP()
        rpt.Site = Me.Site
        Return rpt
    End Function
