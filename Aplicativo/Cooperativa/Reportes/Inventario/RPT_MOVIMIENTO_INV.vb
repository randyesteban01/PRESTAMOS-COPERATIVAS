...
Public Class RPT_MOVIMIENTO_INV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_MOVIMIENTO_INV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_MOVIMIENTO_INV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_MOVIMIENTO_INV = New RPT_MOVIMIENTO_INV()
        rpt.Site = Me.Site
        Return rpt
    End Function
