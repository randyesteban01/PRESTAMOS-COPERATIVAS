...
Public Class RPT_TABLA_PRESTAMOS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_TABLA_PRESTAMOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_TABLA_PRESTAMOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_TABLA_PRESTAMOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_TABLA_PRESTAMOS = New RPT_TABLA_PRESTAMOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
