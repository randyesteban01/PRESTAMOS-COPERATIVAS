...
Public Class RPT_DATA_CREDITO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_DATA_CREDITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_DATA_CREDITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_DATA_CREDITO = New RPT_DATA_CREDITO()
        rpt.Site = Me.Site
        Return rpt
    End Function
