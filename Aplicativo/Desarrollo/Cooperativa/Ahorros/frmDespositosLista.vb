...
Public Class frmDespositosLista
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDespositosLista))
        ...
        Me.Name = "frmDespositosLista"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista de Despositos"
...
#End Region
    ...
    Private Sub frmDespositosLista_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        FillListView()
    End Sub
    Public Sub FillListView()
        ...
        fldToSearch = "c.fld_FullName"
       
        If Trim(txtBuscar.Text) <> "" Then
            sqlSearch = "SELECT d.ID, d.Fecha, ac.CuentaNo, c.fld_FullName, d.Monto FROM  tbl_ahorros_depositos AS d, tbl_clientes AS c, tbl_ahorros_cuentas AS ac WHERE d.IDCliente=c.fld_id AND ac.ID=d.IDCuenta  AND " & fldToSearch & " LIKE " & strTosearch & " ORDER BY d.Fecha DESC LIMIT 0, 15;"
        Else
            sqlSearch = "SELECT d.ID, d.Fecha, ac.CuentaNo, c.fld_FullName, d.Monto FROM  tbl_ahorros_depositos AS d, tbl_clientes AS c, tbl_ahorros_cuentas AS ac WHERE d.IDCliente=c.fld_id AND ac.ID=d.IDCuenta ORDER BY d.Fecha DESC LIMIT 0, 15;"
        End If
    ...
    Private Sub frmDespositosLista_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.Chr(27) Then
            Me.Close()
        End If
    End Sub

    Private Sub frmDespositosLista_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
