...
#End Region
    ...
    Public Sub FillListView()
        ...
        If Trim(txtBuscar.Text) <> "" Then
            sqlSearch = "SELECT d.ID, d.Fecha, ac.CuentaNo, c.fld_FullName, d.Monto FROM tbl_ahorros_retiros AS d, tbl_clientes AS c, tbl_ahorros_cuentas AS ac WHERE d.IDCliente = c.fld_id AND ac.ID = d.IDAhorro  AND " & fldToSearch & " LIKE " & strTosearch & "  ORDER BY d.Fecha ASC LIMIT 0, 50; "
        Else
            sqlSearch = "SELECT d.ID, d.Fecha, ac.CuentaNo, c.fld_FullName, d.Monto FROM tbl_ahorros_retiros AS d, tbl_clientes AS c, tbl_ahorros_cuentas AS ac WHERE d.IDCliente = c.fld_id AND ac.ID = d.IDAhorro ORDER BY d.Fecha ASC LIMIT 0, 50; "
        End If
