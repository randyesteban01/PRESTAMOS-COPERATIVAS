...
Imports System.IO
Public Class frmConfiguracionEstadoResultado
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmConfiguracionEstadoResultado))
        ...
        Me.cmbGrupo.Items.AddRange(New Object() {"INGRESOS", "COSTOS", "GASTOS"})
        ...
        '
        'frmConfiguracionEstadoResultado
        '
        ...
        Me.Name = "frmConfiguracionEstadoResultado"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Estado de Resultado"
...
#End Region
    ...
    Dim Dv As DataView
    Private Sub frmConfiguracionEstadoResultado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        LlenarGrupo()
    End Sub

    Private Sub LlenarGrupo()
        Dim da As New MySqlDataAdapter("SELECT ID, Descripcion FROM tbl_catalogo_grupo WHERE ID IN(4,5,6) ORDER BY Descripcion", conn)
    ...
    Private Sub Fill_DG()
        ...
        Dim sqlSearch = "SELECT ID, CuentaNo , Descripcion , Tipo , EstadoResultado, OrdenEstadoResultado, AccionEstatoResultado  FROM tbl_catalogo WHERE Grupo=" & cmbGrupo.SelectedValue & ""
    ...
    Private Sub AddCustomDataTableStyle()
        ...
        TextCol3.MappingName = "EstadoResultado"
        TextCol3.HeaderText = "ER"
        TextCol3.Width = 33
        ...
        TextCol4.MappingName = "OrdenEstadoResultado"
        TextCol4.HeaderText = "Orden"
        TextCol4.Width = 33
        ...
        TextCol5.MappingName = "AccionEstatoResultado"
        TextCol5.HeaderText = "Accion"
        TextCol5.Width = 33
