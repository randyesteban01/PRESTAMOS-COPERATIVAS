...
Public Class FRM_URBANIZACIONES
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FRM_URBANIZACIONES))
        ...
        Me.Name = "FRM_URBANIZACIONES"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Mantenimiento de Urbanizaciones"
...
#End Region
    ...
    Private Sub FRM_URBANIZACIONES_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = appIcon
        FILL_LIST_VIEW()
    End Sub
    ...
    Private Sub SAVE_DATA()
        ...
        NON_QUERY("INSERT INTO tbl_urbanizacion (fldDescripcion) VALUES('" & fldDescripcion.Text & "')")
    ...
    Private Sub UPDATE_DATA()
        ...
        NON_QUERY("UPDATE tbl_urbanizacion SET fldDescripcion='" & fldDescripcion.Text & "' WHERE fldCodigo = " & fldCodigo.Text & "")
        CLEAR_DATA()
    ...
    Private Sub LOAD_DATA(ByVal id_doc As Integer)
        ...
        With cmd
            .CommandText = "SELECT * FROM tbl_urbanizacion WHERE fldCodigo =" & id_doc & ""
            .Connection = conn
            .Connection.Open()
            dr = .ExecuteReader
    ...
    Private Sub DELETE_DATA(ByVal id_doc As String)
        ...
        NON_QUERY("DELETE FROM tbl_urbanizacion WHERE fldCodigo=" & id_doc & "")
        FILL_LIST_VIEW()
    End Sub
    ...
    Private Sub FILL_LIST_VIEW()
        ...
        If strTosearch <> "" Then
            sqlSearch = "SELECT fldCodigo, fldDescripcion FROM tbl_urbanizacion WHERE " & fldToSearch & " LIKE " & strTosearch & " ORDER BY fldDescripcion ASC LIMIT 150"
        Else
            sqlSearch = "SELECT fldCodigo, fldDescripcion FROM tbl_urbanizacion ORDER BY fldDescripcion ASC LIMIT 150"
        End If

        Dim da As New MySqlDataAdapter(sqlSearch, conn)
        da.Fill(ds, "tbl_urbanizacion")
