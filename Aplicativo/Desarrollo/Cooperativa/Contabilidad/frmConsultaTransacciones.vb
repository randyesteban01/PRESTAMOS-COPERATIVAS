...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents fld_Id_Trans As TextBox
    Friend WithEvents Label4 As Label
    Friend WithEvents RbtnBusqueda As CheckBox
    Friend WithEvents cbDetalle As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmConsultaTransacciones))
        ...
        Me.fld_Id_Trans = New System.Windows.Forms.TextBox()
        Me.Label4 = New System.Windows.Forms.Label()
        Me.RbtnBusqueda = New System.Windows.Forms.CheckBox()
        Me.SuspendLayout()
        '
        'Label3
        '
        ...
        Me.dtpFechaHasta.Location = New System.Drawing.Point(477, 32)
        ...
        Me.dtpFechaDesde.Location = New System.Drawing.Point(478, 8)
        ...
        Me.Label2.Location = New System.Drawing.Point(436, 12)
        ...
        Me.cbDetalle.Location = New System.Drawing.Point(349, 39)
        Me.cbDetalle.Name = "cbDetalle"
        Me.cbDetalle.Size = New System.Drawing.Size(64, 17)
        Me.cbDetalle.TabIndex = 36
        Me.cbDetalle.Text = "Detalles"
        '
        'fld_Id_Trans
        '
        Me.fld_Id_Trans.Location = New System.Drawing.Point(72, 36)
        Me.fld_Id_Trans.MaxLength = 10
        Me.fld_Id_Trans.Name = "fld_Id_Trans"
        Me.fld_Id_Trans.Size = New System.Drawing.Size(104, 20)
        Me.fld_Id_Trans.TabIndex = 37
        '
        'Label4
        '
        ...
        Me.Label4.Text = "Id Trans.:"
        '
        'RbtnBusqueda
        '
        Me.RbtnBusqueda.AutoSize = True
        Me.RbtnBusqueda.Location = New System.Drawing.Point(182, 39)
        Me.RbtnBusqueda.Name = "RbtnBusqueda"
        Me.RbtnBusqueda.Size = New System.Drawing.Size(161, 17)
        Me.RbtnBusqueda.TabIndex = 40
        Me.RbtnBusqueda.Text = "Buscar por #. de Transacion"
        '
        ...
        Me.Controls.Add(Me.RbtnBusqueda)
        Me.Controls.Add(Me.Label4)
        Me.Controls.Add(Me.fld_Id_Trans)
...
#Region "ALL SUB"
    ...
    Private Sub lvEmcabezado()
        ...
        Dim accion As Short
        If RbtnBusqueda.Checked = False Then
        ...
        Else
            ...
            sqlSearch = "SELECT t.TransID, t.TransFechaMovimiento, t.TransDescripcion, SUM(td.TransDDebito) FROM tbl_interfascontabletransacciones AS t, tbl_interfasecontabletransaccionesdetalles AS td, tbl_interfascontableotrastipo AS tp WHERE td.TransDIDTrans=t.TransID AND t.TransIDTipo=tp.fld_id AND t.TransID= " & fld_Id_Trans.Text.Trim & " GROUP BY td.TransDIDTrans"
    ...
    Private Sub lvDetalle()
        ...
        Dim sqlSearch As String
        Dim accion As Short
        If cbDetalle.Checked = True And RbtnBusqueda.Checked = True Then
            sqlSearch = "SELECT t.TransID, t.TransFechaMovimiento, t.TransDescripcion, td.TransDCuentaNo, td.TransDDescripcionCuenta, td.TransDDebito, td.TransDCredito  FROM tbl_interfascontabletransacciones AS t, tbl_interfasecontabletransaccionesdetalles AS td, tbl_interfascontableotrastipo AS tp 
WHERE td.TransDIDTrans=t.TransID AND t.TransIDTipo=tp.fld_id AND t.TransFechaMovimiento 
AND t.TransID='" & fld_Id_Trans.Text.Trim & "' ORDER BY td.TransDIDTrans, td.TransDCredito"

            'sqlSearch = "SELECT t.TransID, t.TransFechaMovimiento, t.TransDescripcion, td.TransDCuentaNo, td.TransDDescripcionCuenta, td.TransDDebito, td.TransDCredito  FROM tbl_interfascontabletransacciones AS t, tbl_interfasecontabletransaccionesdetalles AS td, tbl_interfascontableotrastipo AS tp WHERE td.TransDIDTrans=t.TransID AND t.TransIDTipo=tp.fld_id AND t.TransFechaMovimiento BETWEEN '" & formatDate(dtpFechaDesde.Value.Date) & "' AND '" & formatDate(dtpFechaHasta.Value.Date) & "' AND t.TransID= " & fld_Id_Trans.Text.Trim & " ORDER BY td.TransDIDTrans, td.TransDCredito"
...
#End Region
    ...
    Private Sub Imprimir()
        ...
        Try
            If result = DialogResult.Cancel Then
                ...
                Next
                If RbtnBusqueda.Checked = True And cbDetalle.Checked = True Then
                    Dim daRecord As New MySqlDataAdapter("SELECT * FROM view_cont_transacciones WHERE transid='" & fld_Id_Trans.Text.Trim & "' ", conn)
    ...
    Private Sub RbtnBusqueda_CheckedChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub RbtnBusqueda_CheckedChanged_1(sender As Object, e As EventArgs) Handles RbtnBusqueda.CheckedChanged
        If RbtnBusqueda.Checked = True Then
            fld_Id_Trans.Enabled = True
