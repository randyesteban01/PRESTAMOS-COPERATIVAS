...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCrearCtaContable))
        ...
        Me.btnNueva.Location = New System.Drawing.Point(674, 40)
        Me.btnNueva.Name = "btnNueva"
        Me.btnNueva.Size = New System.Drawing.Size(72, 56)
        Me.btnNueva.TabIndex = 19
...
#End Region
    ...
    Private Sub Guardar()
        ...
        IdCatCta = UltimoID("tbl_catalogo", "ID") + 1

        NON_QUERY("INSERT INTO tbl_catalogo (ID,CuentaNo, Descripcion, Grupo, Tipo, CtaControl,Fecha, Usuario) VALUES(" & IdCatCta & ",'" & txtCuentaNo.Text & "','" & txtDescripcion.Text & "'," & cmbGrupo.SelectedValue & ",'" & cmbTipo.Text & "','" & control & "',Now(),'" & User(0) & "')")
    End Sub
