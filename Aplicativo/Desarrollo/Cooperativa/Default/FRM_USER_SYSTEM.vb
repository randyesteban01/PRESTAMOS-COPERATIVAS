...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRM_USER_SYSTEM))
        ...
        Me.btnCerrar.Location = New System.Drawing.Point(504, 139)
        ...
        Me.btnGuardar.Location = New System.Drawing.Point(432, 139)
        ...
        Me.btnNuevo.Location = New System.Drawing.Point(360, 139)
        ...
        'LV
        '
        Me.LV.Location = New System.Drawing.Point(8, 201)
        Me.LV.Name = "LV"
        Me.LV.Size = New System.Drawing.Size(568, 295)
        Me.LV.TabIndex = 21
        Me.LV.UseCompatibleStateImageBehavior = False
        '
        'lblDepartamento
        '
        Me.lblDepartamento.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!)
        Me.lblDepartamento.Location = New System.Drawing.Point(272, 104)
        Me.lblDepartamento.Name = "lblDepartamento"
        Me.lblDepartamento.Size = New System.Drawing.Size(80, 16)
        ...
        Me.txtDepartamento.Location = New System.Drawing.Point(360, 105)
...
#End Region
    ...
    Private Sub SaveData()
        NON_QUERY("INSERT INTO tbl_User (fld_UserID,fld_Password,fld_FirstName,fld_LastName,fld_departamento,FLD_CARGO,fld_Created,fld_Status,fld_tipo,IDRol) VALUES('" & txtUserID.Text & "','" & txtPassword.Text & "','" & txtFirstName.Text & "','" & txtLastName.Text & "','" & txtDepartamento.Text & "','" & txtCargo.Text & "',NOW(),'N','" & cbRol.Text & "'," & cbRol.SelectedValue & ")")


    End Sub
    Private Sub UpDateData(ByVal IDUsuario As Integer)
        NON_QUERY("UPDATE tbl_User SET fld_FirstName='" & txtFirstName.Text & "', fld_LastName='" & txtLastName.Text & "', fld_departamento='" & txtDepartamento.Text & "', FLD_CARGO='" & txtCargo.Text & "', fld_tipo='" & cbRol.Text & "', IdRol=" & cbRol.SelectedValue & " WHERE fld_id=" & IDUsuario & " ")
    ...
    Private Sub cargarDatos(ByVal id As Integer)
        ...
        For Each nr In ds.Tables(0).Rows
            ...
            txtDepartamento.Text = nr("fld_departamento")
