...
Public Class rptAhorroRetiroSP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptAhorroRetiroSP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAhorroRetiroSP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAhorroRetiroSP = New rptAhorroRetiroSP()
        rpt.Site = Me.Site
        Return rpt
    End Function
