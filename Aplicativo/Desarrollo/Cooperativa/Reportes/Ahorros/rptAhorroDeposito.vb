...
Public Class rptAhorroDeposito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptAhorroDeposito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAhorroDeposito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAhorroDeposito = New rptAhorroDeposito()
        rpt.Site = Me.Site
        Return rpt
    End Function
