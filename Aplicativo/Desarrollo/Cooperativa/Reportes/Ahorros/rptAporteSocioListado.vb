...
Public Class rptAporteSocioListado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAporteSocioListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptAporteSocioListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAporteSocioListado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAporteSocioListado = New rptAporteSocioListado()
        rpt.Site = Me.Site
        Return rpt
    End Function
