...
Public Class rptDepositosListado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDepositosListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptDepositosListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDepositosListado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDepositosListado = New rptDepositosListado()
        rpt.Site = Me.Site
        Return rpt
    End Function
