...
Public Class rptRetiroAporteSocioListado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRetiroAporteSocioListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptRetiroAporteSocioListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRetiroAporteSocioListado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRetiroAporteSocioListado = New rptRetiroAporteSocioListado()
        rpt.Site = Me.Site
        Return rpt
    End Function
