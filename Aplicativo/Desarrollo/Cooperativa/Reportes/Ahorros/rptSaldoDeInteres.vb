...
Public Class rptSaldoDeInteres
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptSaldoDeInteres.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldoDeInteres
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldoDeInteres = New rptSaldoDeInteres()
        rpt.Site = Me.Site
        Return rpt
    End Function
