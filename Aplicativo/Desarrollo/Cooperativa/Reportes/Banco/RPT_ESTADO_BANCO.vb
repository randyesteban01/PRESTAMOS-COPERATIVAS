...
Public Class RPT_ESTADO_BANCO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_ESTADO_BANCO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ESTADO_BANCO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ESTADO_BANCO = New RPT_ESTADO_BANCO()
        rpt.Site = Me.Site
        Return rpt
    End Function
