...
Public Class RPT_EGRESO_DE_CAJA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_EGRESO_DE_CAJA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_EGRESO_DE_CAJA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_EGRESO_DE_CAJA = New RPT_EGRESO_DE_CAJA()
        rpt.Site = Me.Site
        Return rpt
    End Function
