...
Public Class RPT_LISTA_RECIBOS_EGRESOS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_LISTA_RECIBOS_EGRESOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_LISTA_RECIBOS_EGRESOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_LISTA_RECIBOS_EGRESOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_LISTA_RECIBOS_EGRESOS = New RPT_LISTA_RECIBOS_EGRESOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
