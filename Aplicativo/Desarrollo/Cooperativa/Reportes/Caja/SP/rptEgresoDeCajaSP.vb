...
Public Class rptEgresoDeCajaSP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptEgresoDeCajaSP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEgresoDeCajaSP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEgresoDeCajaSP = New rptEgresoDeCajaSP()
        rpt.Site = Me.Site
        Return rpt
    End Function
