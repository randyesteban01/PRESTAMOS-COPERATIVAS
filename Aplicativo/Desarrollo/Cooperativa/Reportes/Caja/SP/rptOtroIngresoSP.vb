...
Public Class rptOtroIngresoSP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptOtroIngresoSP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOtroIngresoSP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOtroIngresoSP = New rptOtroIngresoSP()
        rpt.Site = Me.Site
        Return rpt
    End Function
