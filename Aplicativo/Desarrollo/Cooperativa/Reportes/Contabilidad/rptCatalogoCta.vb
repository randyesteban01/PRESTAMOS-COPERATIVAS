...
Public Class rptCatalogoCta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.rptCatalogoCta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatalogoCta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatalogoCta = New rptCatalogoCta()
        rpt.Site = Me.Site
        Return rpt
    End Function
