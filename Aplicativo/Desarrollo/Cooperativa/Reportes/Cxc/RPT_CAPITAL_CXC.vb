...
Public Class RPT_CAPITAL_CXC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CAPITAL_CXC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CAPITAL_CXC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CAPITAL_CXC = New RPT_CAPITAL_CXC()
        rpt.Site = Me.Site
        Return rpt
    End Function
