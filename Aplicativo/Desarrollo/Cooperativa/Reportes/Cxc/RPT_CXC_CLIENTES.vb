...
Public Class RPT_CXC_CLIENTES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CXC_CLIENTES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CXC_CLIENTES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CXC_CLIENTES = New RPT_CXC_CLIENTES()
        rpt.Site = Me.Site
        Return rpt
    End Function
