...
Public Class RPT_NC_CXC_LISTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_NC_CXC_LISTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_NC_CXC_LISTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_NC_CXC_LISTA = New RPT_NC_CXC_LISTA()
        rpt.Site = Me.Site
        Return rpt
    End Function
