...
Public Class RPT_CUOTAS_EN_ATRASO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_CUOTAS_EN_ATRASO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_CUOTAS_EN_ATRASO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CUOTAS_EN_ATRASO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CUOTAS_EN_ATRASO = New RPT_CUOTAS_EN_ATRASO()
        rpt.Site = Me.Site
        Return rpt
    End Function
