...
Public Class RPT_LISTADO_COBROS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_LISTADO_COBROS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_LISTADO_COBROS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_LISTADO_COBROS = New RPT_LISTADO_COBROS()
        rpt.Site = Me.Site
        Return rpt
    End Function
