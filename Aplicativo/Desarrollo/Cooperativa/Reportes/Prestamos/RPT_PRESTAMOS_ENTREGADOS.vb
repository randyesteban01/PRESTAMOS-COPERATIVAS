...
Public Class RPT_PRESTAMOS_ENTREGADOS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_PRESTAMOS_ENTREGADOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_PRESTAMOS_ENTREGADOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PRESTAMOS_ENTREGADOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PRESTAMOS_ENTREGADOS = New RPT_PRESTAMOS_ENTREGADOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
