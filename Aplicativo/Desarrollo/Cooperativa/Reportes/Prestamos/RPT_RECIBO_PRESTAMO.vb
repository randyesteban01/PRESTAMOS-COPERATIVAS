...
Public Class RPT_RECIBO_PRESTAMO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_RECIBO_PRESTAMO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cooperativa.RPT_RECIBO_PRESTAMO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_RECIBO_PRESTAMO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_RECIBO_PRESTAMO = New RPT_RECIBO_PRESTAMO()
        rpt.Site = Me.Site
        Return rpt
    End Function
